...
const DEMO_CARDS = [
  {
    ...
    bEl: 'Δύο ώρες shinrin-yoku αρκούν για μετρήσιμη πτώση του στρες και ενίσχυση του ανοσοποιητικού.',
    bEn: 'Two hours of shinrin-yoku measurably lower stress and boost immune activity.',
  ...
  },
  {
    ...
    bEl: 'Είκοσι φορές περισσότερους από όσους πιστεύαμε. Ο δικός μας είναι ένας στα δύο τρισεκατομμύρια.',
    bEn: 'Twenty times more than we thought. Ours is one in two trillion.',
  ...
  },
  {
    ...
    bEl: 'Ο Μάρκος Αυρήλιος έγραφε: μη ζητάς να γίνονται όπως θέλεις. Θέλε τα όπως γίνονται.',
    bEn: 'Marcus Aurelius wrote: do not ask that things happen as you wish. Wish them as they happen.',
