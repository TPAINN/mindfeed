...
const sampleCards = (m) => [
  {
    ...
    body: 'Ιαπωνική έρευνα ανακάλυψε ότι ακόμα και μια σύντομη βόλτα σε δασικό περιβάλλον μειώνει σημαντικά τα επίπεδα κορτιζόλης (ορμόνη του στρες). Το φαινόμενο ονομάζεται "Shinrin-yoku" (δασικό μπάνιο) και έχει την ίδια αποτελεσματικότητα με την ελαφριά άσκηση στη μείωση του άγχους.',
  ...
  },
  {
    ...
    body: 'Η έκθεση στο φυσικό φως τα πρώτα 30-60 λεπτά μετά το ξύπνημα ρυθμίζει τον κιρκάδιο ρυθμό — τον βιολογικό ρυθμό 24 ωρών που ελέγχει ύπνο, εγρήγορση, ορμόνες και μεταβολισμό. Ο Dr. Andrew Huberman (Stanford) το ονομάζει "πιο ισχυρό δωρεάν εργαλείο βελτιστοποίησης".',
  ...
  },
  {
    ...
    body: 'Αστρονόμοι του Πανεπιστημίου Nottingham αναθεώρησαν τον αριθμό των γαλαξιών από 200 δισ. σε 2 τρισεκατομμύρια. Αν μετρούσες έναν ανά δευτερόλεπτο, θα χρειαζόσουν 63.000 χρόνια.',
  ...
  },
  {
    ...
    whyItMatters: 'Απάντησε σε εκείνο το email τώρα. Παίρνει λιγότερο από 2 λεπτά.',
  ...
  {
    title: 'Το έντερό σου παράγει το 90% της σεροτονίνης',
    body: 'Ο "δεύτερος εγκέφαλος" — το εντερικό νευρικό σύστημα — περιέχει 500 εκατ. νευρώνες και παράγει το 90% της σεροτονίνης. Αυτό εξηγεί γιατί η διατροφή επηρεάζει άμεσα τη διάθεση και το άγχος.',
  ...
  },
  {
    ...
    body: 'Marcus Aurelius και Nietzsche συμφωνούν: "Amor Fati" δεν σημαίνει παθητική αποδοχή — σημαίνει να αγκαλιάζεις ενεργά κάθε εμπόδιο ως καύσιμο ανάπτυξης. "The obstacle is the way."',
  ...
  {
    title: 'Κοιμάσαι λιγότερο από 7 ώρες; Ο εγκέφαλός σου "τρώει" τον εαυτό του',
    body: 'Έρευνα του Matthew Walker δείχνει ότι έλλειψη ύπνου ενεργοποιεί αυτοφαγία στον εγκέφαλο — η astrocytic phagocytosis καταστρέφει συναπτικές συνδέσεις. Χρόνια έλλειψη ύπνου = +30% κίνδυνος Alzheimer.',
  ...
  {
    title: 'Ανατοκισμός: Ο Αϊνστάιν τον αποκάλεσε "8ο θαύμα του κόσμου"',
  ...
  {
    title: 'Τα χταπόδια "βλέπουν" χρώματα παρόλο που έχουν αχρωματοψία',
    body: 'Τα χταπόδια έχουν μόνο έναν τύπο φωτοϋποδοχέα αλλά αλλάζουν χρώμα με εκπληκτική ακρίβεια. Θεωρία: χρησιμοποιούν chromatic aberration μέσω της παράδοξης κόρης τους — ουσιαστικά "βλέπουν" με εστίαση αντί χρωματικών υποδοχέων.',
    whyItMatters: 'Η εξέλιξη βρίσκει λύσεις που δεν φανταζόμαστε.',
    tldr: 'Χταπόδια: αχρωματοψία, αλλά "βλέπουν" χρώματα. Ακόμα το ερευνούμε.',
